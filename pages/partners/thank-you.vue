  ...
  <div>
    <section class="page-hero" style="min-height: 60vh; display: flex; align-items: center;">
      <div class="container" style="text-align: center;">
        ...
        <h1 style="font-size: 36px; font-weight: 800; color: var(--navy); margin-bottom: 16px;">Thank You!</h1>
        <p style="font-size: 17px; color: var(--body); max-width: 480px; margin: 0 auto 32px; line-height: 1.7;">We have received your partnership inquiry. A member of our team will reach out to you shortly.</p>
...
export default {
  head() {
    return { title: 'Thank You | Drip Capital' }
  }
}
</script>
