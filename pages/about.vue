        ...
        <div class="mission-pillars">
          ...
          >
            <div class="mission-icon">
              <AppIcon :name="pillar.icon" :size="24" color="var(--green)" />
            </div>
    ...
    return {
      ...
      team: [
        ...
        },
        {
          ...
          photo: '/team/gurpreet-bilkhu.png',
          initials: 'GK',
          color: '#5B2D8E'
        },
        {
