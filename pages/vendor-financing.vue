      ...
      <div class="container">
        <div class="cta-simple reveal">
          ...
          <div class="cta-simple-actions">
            <NuxtLink to="/en-us/contact" class="btn btn-primary btn-lg">Apply for Vendor Financing →</NuxtLink>
            <NuxtLink to="/en-us/receivables-financing" class="btn btn-outline btn-lg">Compare Products</NuxtLink>
          </div>
        </div>
      </div>
    </section>
